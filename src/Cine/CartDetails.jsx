...
export default function CartDetails({onClose}) {
  ...
  const removeMovieFromCart=(e, itemId)=>{
    e.preventDefault();

    const filterData = cartData.filter(cart=> cart.id !== itemId)
           ...
           cartData.length > 0 ? (
             cartData.map(item=>(
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h3 className="text-white md:text-xl font-bold">{item.ttile}</h3>
              ...
              <div className="flex justify-between gap-4 items-center">
                <button
                  ...
                  onClick={(e)=>removeMovieFromCart(e, item.id)}
                >
